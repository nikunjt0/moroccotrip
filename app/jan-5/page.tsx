import EssaouiraMap from '../components/EssaouiraMapWrapper';
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 mb-8">
          Day 4 of your Morocco trip - Journey to Essaouira
        </p>
        ...
        <div className="mb-8 bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-6 border border-zinc-200 dark:border-zinc-800">
          ...
          <div className="space-y-4">
            ...
            <a
              href="https://www.hostelworld.com/pwa/s?q=Essaouira,%20Morocco&country=Morocco&city=Essaouira&type=city&id=457&from=2026-01-05&to=2026-01-06&guests=5&page=1"
              target="_blank"
          ...
          <div className="space-y-4 text-zinc-700 dark:text-zinc-300">
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Bus to <strong>Essaouira</strong> (~3 hrs from Marrakesh)</li>
              </ul>
            </div>
            <div className="space-y-2 pt-4 border-t border-zinc-200 dark:border-zinc-800">
              <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Afternoon & Evening</h3>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Windsurfing/surfing</li>
                <li>Beach fun</li>
                <li>Explore <strong>ramparts</strong> and <strong>port</strong></li>
                <li>Sunset on the walls</li>
                <li>Art & live music</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative w-full h-[400px] rounded-lg overflow-hidden shadow-lg border border-zinc-200 dark:border-zinc-800">
            <Image
              src="/jan-5/essouira-walls.avif"
              alt="Essaouira walls and ramparts"
              fill
          ...
          <div className="relative w-full h-[400px] rounded-lg overflow-hidden shadow-lg border border-zinc-200 dark:border-zinc-800">
            <Image
              src="/jan-5/essaouira-streets.jpg"
              alt="Essaouira streets"
              fill
              className="object-cover"
              sizes="(max-width: 768px) 100vw, 50vw"
            />
