import FezMap from '../components/FezMapWrapper';
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 mb-8">
          Day 8 of your Morocco trip - Merzouga to Fez
        </p>
        ...
        <div className="mb-8 bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-6 border border-zinc-200 dark:border-zinc-800">
          ...
          <div className="space-y-4">
            ...
            <a
              href="https://www.hostelworld.com/pwa/s?q=Fez,%20Morocco&country=Fez&city=Fez&type=city&id=6102&from=2026-01-09&to=2026-01-10&guests=5&page=1"
              target="_blank"
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-6 border border-zinc-200 dark:border-zinc-800">
          ...
          <div className="space-y-4 text-zinc-700 dark:text-zinc-300">
            ...
            <div className="space-y-2 pt-4 border-t border-zinc-200 dark:border-zinc-800">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Drive north via the <strong>Ziz Valley</strong> / <strong>Midelt</strong> direction to <strong>Fez</strong> (around a 7 hr drive)</li>
              </ul>
            </div>
            <div className="space-y-2 pt-4 border-t border-zinc-200 dark:border-zinc-800">
              <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Evening & Night</h3>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Arrive in <strong>Fez</strong> in the evening</li>
                <li>Grab a late meal</li>
                <li>Low-key night</li>
              </ul>
            </div>
          </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative w-full h-[400px] rounded-lg overflow-hidden shadow-lg border border-zinc-200 dark:border-zinc-800">
            <Image
              src="/jan-9/ziz-valley.jpg"
              alt="Ziz Valley, Morocco"
              fill
          ...
          <div className="relative w-full h-[400px] rounded-lg overflow-hidden shadow-lg border border-zinc-200 dark:border-zinc-800">
            <Image
              src="/jan-9/fes-night.jpg"
              alt="Fez at night, Morocco"
              fill
              className="object-cover"
              sizes="(max-width: 768px) 100vw, 50vw"
            />
